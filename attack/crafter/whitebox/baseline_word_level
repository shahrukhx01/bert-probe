...
class BaselineWhiteboxWordLevelAttack(AttackRecipe):
    """
    The blackbox word level attack is an extension on the following study:
    BAE: BERT-based Adversarial Examples for Text Classification and
    ...
    def build(model_wrapper, model_name):
        ...
        return BaselineWhiteboxWordLevelAttack(
